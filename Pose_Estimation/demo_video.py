...
#weight_name = '/scratch/ea1921/pytorch_Realtime_Multi-Person_Pose_Estimation/model/pose_model.pth'
...
#    canvas = cv2.imread(test_image) # B,G,R order
    ...
    print 'subset2 is ', subset, len(subset)
    ...
    print 'candidate is ', candidate
    print 'output is ', output_coordinates
