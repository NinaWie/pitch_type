...
#    canvas = cv2.imread(test_image) # B,G,R order
    ...
    #     person_arr = []
    #     for i in range(18):
    #         print(i,j, all_peaks[i][j][0:2])
    #         person_arr.append(np.array(all_peaks[i][j][0:2]))
    #         cv2.circle(canvas, all_peaks[i][j][0:2], 4, colors[i], thickness=-1)
    #     outs.append(person_arr)
    #
