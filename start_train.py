...
print(data.shape, len(labels_string))

runner = Runner(data, labels_string, np.unique(labels_string), normalize = True, SAVE = "./modelPitchingPosition/model", RESTORE = None, BATCH_SZ=40, EPOCHS = 10, batch_nr_in_epoch = 100, align = False,
