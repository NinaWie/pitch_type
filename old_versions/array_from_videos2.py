...
dates = ["2017-04-15", "2017-04-19", "2017-05-03", "2017-05-07", "2017-05-20", "2017-05-24", "2017-06-07", "2017-06-11", "2017-06-19", "2017-06-23", "2017-07-05", "2017-07-17"]
# only first two rows von den im cluster angezeigten
# output_folder=args.output_dir
# schon gemacht: [["2017-04-15", "2017-04-19", "2017-05-03", "2017-05-07"],"2017-04-14", "2017-04-18", "2017-05-02", "2017-05-06", "2017-05-19", "2017-05-23", "2017-06-06", "2017-06-10" ["2017-06-18", "2017-06-22", "2017-07-04", "2017-07-16"]]
    ...
    for f in list_files:
	    ...
	    for i in open(input_dir+f+".dat").readlines():
            ...
            while True:
                ...
                pitcher = cv2.resize(np.mean(pitcher, axis = 2),(55, 55), interpolation = cv2.INTER_LINEAR)/255 #scipy.misc.imresize(pitcher, (109, 143, 3))/255
