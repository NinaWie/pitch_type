...
def speed_estimation_2D(trajectory, fps = 30, factor_pixel_feet=10):
    ...
    print("speed in mph: "+ str(speed*fps* 0.681818 /factor_pixel_feet))
    return mph
...
def release_frame(balls, t, images=None):
    ...
    dist_from_start = distance_projected(trajectory[0, :2], np.array([110, 140]),np.array([690, 288]))
